...
<div id ="container" class="w-50 p-2 border-0 mx-auto text-center mt-5 bg-light" style=" max-width: 450px">
    <form method="post" action="">
        ...
        <div class="form-group">
            ...
            <p class="font-italic">Bấm vào đăng ký nghĩa là bạn đã đọc và đồng ý với <a href="#"
                                                                                        class="text-warning ">Điều khoản sử dụng của Chợ Tốt
                </a>.</p>
        </div>
        <hr>
        <div class="form-group">
            <small>Hoặc</small>
            <p>Bạn đã có tài khoản? <a href="formLogin.php">Đăng nhập</a></p>
        </div>
    </form>
</div>
